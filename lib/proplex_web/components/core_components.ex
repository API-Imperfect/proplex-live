defmodule ProplexWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: ProplexWeb.Gettext
  ...
  attr :rest, :global,
    include: ~w(autocomplete required phx-debounce phx-mounted phx-blur phx-focus)
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ProplexWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ProplexWeb.Gettext, "errors", msg, opts)
    end
  end
